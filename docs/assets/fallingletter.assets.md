...
# `fallingletter` — graphics declaration

| Field | Value |
| --- | --- |
| Game id | `fallingletter` (fallingletter.js / FallingLetter.tscn) |
| Owns any art? | no |
| Shared pools used | None — balloons, danger line, HUD and the in-canvas keyboard are all drawn from palette roles. |
| Content file(s) | — (none) |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| balloons / keyboard | — (drawn) | — | — | — | — | tier = LEVELS row | — |
