...
# `tictactoe` — graphics declaration

| Field | Value |
| --- | --- |
| Game id | `tictactoe` (tictactoe.js / TicTacToe.tscn) |
| Owns any art? | no |
| Shared pools used | None — grid and X / O marks drawn. |
| Content file(s) | — (none) |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| grid / marks | — (drawn) | — | — | — | — | opponent strength = level | — |
