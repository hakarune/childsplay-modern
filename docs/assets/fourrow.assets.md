...
# `fourrow` — graphics declaration

| Field | Value |
| --- | --- |
| Game id | `fourrow` (fourrow.js / FourRow.tscn) |
| Owns any art? | no |
| Shared pools used | None — board and discs drawn; disc colours are the p1 / p2 palette roles. |
| Content file(s) | — (none) |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| board / discs | — (drawn) | — | — | — | — | AI level (not visual) | — |
